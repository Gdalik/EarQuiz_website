...
To complete a test, you should do ten examples in a row. [Use sliders' handles to input the guessed answers]({{ site.url }}{{ site.baseurl }}/manuals/earquiz-frequencies-help/equalization-patterns-sliders-settings/#equalization-sliders).
